...
static u32 dwc3_calc_trbs_left(struct dwc3_ep *dep)
{
	 ...
	 *
	 * One way to know for sure is if there is any request remained in
	 * the started_list with active TRBs at this point. If there is,
	 * we're definitely full and can't fit any more transfers in our
	 * ring.
	 */
